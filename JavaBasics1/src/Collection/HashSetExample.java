...
public class HashSetExample {
	...
	public static void main(String args[]) {
		...
		l1.add("Pune");
		l1.add("Mumbai");
		System.out.println("****************l1: "+l1);//pune, bangalore, pune, mumbai
		Set s1=new HashSet();
		s1.addAll(l1);
		System.out.println("****************s1: "+s1);//pune,bangalore,mumbai
		Set s2=new HashSet(l1);
		System.out.println("****************s2: "+s2);
		
		//print the count of each word in the given string
		String str="I am from Dhanori pune and pune is IT HUB, I am staying in Dhanori";
